        ...
        if (isEvalSync) {
            ...
            try {
                let _ai = await ai({ 
                   ...
                   msgtype: cht?.type,
                   _logic: " -kamu bernama zetta, dengan nama lengkap vestia zeta kamu memiliki gender wanita yang berumur 18 tahun dengan sifat ramah, pembuat atau ownermu adalah syawaliuz octavian, jika kamu di tanya siapa pembuatmu jawablah lalu kirimkan nomor ownermu, dan jika ada yang menanyakan kamu itu apa jawablah dengan senang hati bahwa kamu ai yang di ciptakan oleh syawaliuz octavian ",
                   image: isImage
                })
                let config = _ai?.data ?? {}
                console.log(config)
